    ...
    while not rospy.is_shutdown():
        ...
        if ch in ["w", "a", "s", "d"]:
            ...
            try:
                ...
                rospy.loginfo("Attempting to move down by 2 cm...")
                ...
                if not success:
                    rospy.logerr("Move down aborted or failed — skipping grasp.")
                    continue  
                rospy.loginfo("Moved down successfully, proceeding to grasp...")
                ...
                # move up by 30 cm
                pose = arm_group.get_current_pose('panda_hand_tcp')
                ...
                rospy.logerr(f"Exception during move down or grasp: {e}")
                continue 
        else:
            continue
